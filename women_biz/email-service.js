...
(function() {
    // Função para gerar o relatório de consultoria com base nos dados do formulário
    function generateConsultancyReport(formData) {
        const tipoNegocio = formData.get('tipoNegocio');
        const estagioNegocio = formData.get('estagioNegocio');
        ...
        <body>
            ...
            <p>Obrigado por preencher nosso formulário de consultoria. Com base nas informações fornecidas, preparamos este relatório personalizado para ajudar no desenvolvimento do seu negócio.</p>
            ...
            <div class="section">
                ...
                <p>Criamos um board no Trello com todas as tarefas necessárias para implementação do seu projeto. Acesse através do link abaixo:</p>
            ...
            <div class="footer">
                <p>Este relatório foi gerado automaticamente com base nas informações fornecidas no formulário de consultoria.</p>
    ...
    window.EmailService = {
        generateConsultancyReport: generateConsultancyReport
    };
})();
