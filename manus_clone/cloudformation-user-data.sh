#!/bin/bash
# CloudFormation User Data Script for EC2 Browser Automation
# This script is designed to be used as user data in CloudFormation templates

# Encode the bootstrap script in base64
...
# Decode and execute bootstrap script
echo "${BOOTSTRAP_SCRIPT}" | base64 --decode > /tmp/bootstrap.sh
chmod +x /tmp/bootstrap.sh
/tmp/bootstrap.sh

# Signal CloudFormation that the instance is ready
# This is used when the instance is part of an Auto Scaling Group with a CreationPolicy
